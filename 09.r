...
def login():
    ...
    print "\033[1;97m[➊]\x1b[3;93mSTART\x1b[1;96m CRACKING  \033[1;0m "  
    time.sleep(0.05)
...
def action():
    ...
    if Somi =='':
        ...
        os.system("clear")
        print logo1
        print "\033[4;45mENTER ANY PAKISTAN  NUMBER"+'\n\033[1;0m \x1b[3;95m'
        print '00 TO 49")'
        try:
    ...
    jalan ("[🔃]\033[1;0m\033[3;93mTO STOP THIS PROCESS PRESS Ctrl THEN Z")
    jalan ("[‼️]\033[3;94mPLEASE WAIT........")
    print 47* '━'
    def main(arg):
        global cpb,oks
        user = arg
